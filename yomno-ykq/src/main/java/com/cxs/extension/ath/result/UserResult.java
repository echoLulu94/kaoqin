...
public class UserResult {
    ...
    public static Map.Entry<String, String> UPDATE_BY_NOT_NULL = new AbstractMap.SimpleEntry<String, String>("ATH121514", "学号或者手机号不能为空");
    public static Map.Entry<String, String> LOGIN_FAILURE = new AbstractMap.SimpleEntry<String, String>("ATH121610", "登录失败！");
    public static Map.Entry<String, String> LOGIN_ID_NOT_NULL = new AbstractMap.SimpleEntry<String, String>("ATH121610", "登录时学号不能为空！");
